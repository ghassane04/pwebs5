        ...
        <main>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div class="d-none d-lg-block">
                            <a href="login.php"data-toggle="modal" data-target="#modal-form"class="btn custom-btn custom-border-btn btn-naira btn-inverted">
                                <i class="btn-icon"></i>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-12 mb-5 pb-5 pb-lg-0 mb-lg-0">
                            <h6>Introducing e-learning</h6>
                            <h1 class="text-white mb-4">e-learning landing page for beginners</h1>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-12"><br>
                            <img src="images/sign.jpeg" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="book-section-info">
                                <h6>Modern &amp; Creative</h6>
                                <h3 class="mb-4">About The e-learning</h3>
                                <p>Credit goes to <a rel="nofollow" href="https://www.w3schools.com/" target="_blank">W3schools</a> at our e-learning platform, we are driven by a passion for education and a commitment to providing an exceptional learning experience. With our diverse range of courses, flexible learning options, and personalized approach, we strive to empower learners of all backgrounds to acquire new skills, expand their knowledge, and achieve their educational goals.</p>
                                <p>We believe that education should be accessible, engaging, and adaptable to individual needs, and we are dedicated to leveraging innovative technology to deliver a cutting-edge learning experience. Join us on this exciting journey of lifelong learning and unlock your full potential.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="author-section section-padding" id="section_3">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <img src="images/pdp.jpg" class="author-image img-fluid" alt="">
                        </div>
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <h6>Meet Author</h6>
                            <h2 class="mb-4">Prof. Amine</h2>
                            <p>This is an e-learning landing page template with Bootstrap 5 CSS framework. It is easy to customize with the use of Bootstrap CSS classes.</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-12 text-center mb-5">
                            <h6>Lessons</h6>
                            <h2>What are our courses...</h2>
                        </div>
                        <div class="col-lg-4 col-12">
                            <div class="custom-block d-flex flex-wrap">
                                <div class="custom-block-image-wrap d-flex flex-column">
                                    <div><img id="leftItemImg" src="" alt="" width="100%" height="100%" style="border-radius: 25px 25px 25px 25px;"/></div>
                                    <br><div><h3 id="leftItemH2"style="text-align: center"></h3></div>
                        ...
                        <div class="col-lg-4 col-12 ">
                            <div class="custom-block d-flex flex-wrap">
                                <div class="custom-block-image-wrap d-flex flex-column">
                                    <div><img id="centerItemImg" src="" alt="" width="100%" height="100%" style="border-radius: 25px 25px 25px 25px;"/></div>
                                    <br><div><h3 id="centerItemH2"style="text-align: center"></h3></div>
                                    <div id="price2"style="text-align: center"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-12">
                            <div class="custom-block d-flex flex-wrap">
                                <div class="custom-block-image-wrap d-flex flex-column">                                    
                                    <div><img id="rightItemImg" src="" alt="" width="100%" height="100%" style="border-radius: 25px 25px 25px 25px;"/></div>
                                    <br><div><h3 id="rightItemH2"style="text-align: center"></h3></div>
                                    <div id="price3"style="text-align: center"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-5 col-12 mx-auto">
                            <form class="custom-form ebook-download-form bg-white shadow" action="#" method="post" role="form">
                                <div class="text-center mb-5">
                                    <h2 class="mb-1">Get your e-learning pass</h2>
                                </div>
                                <div class="ebook-download-form-body">
                                    ...
                                    <div class="col-lg-8 col-md-10 col-8 mx-auto">
                                        <button type="submit" class="form-control">Send it</button>
                                    </div>
                                </div>
                            </form>
                        </div>
